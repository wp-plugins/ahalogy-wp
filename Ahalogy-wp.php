...
class ahalogyWP {
		...
		<div class="icon32" id="icon-options-general"><br /></div>
			...
			<form name="form1" id="form1" method="post" action="options.php">
				...
				<p style="font-size:0.95em"><?php
					printf( __( '<a href="%1$s">Welcome to Ahalogy</a>.', $this->plugin_textdomain ), $this->plugin_homepage ); ?></p>

				<table class="form-table">

					<?php $this->optionsDrawCheckbox( 'insert_code', 'Include Ahalogy code on your site?', '', 'color:#000;' ); ?>
	...
	$disabled = sprintf('
		<!--
		Ahalogy-WP Plugin is installed but widget code is turned off or Client ID not set (http://app.ahalogy.com/wp/) [version %1$s]
		-->'
	,
		$this->plugin_version
	);
	...
	// Ahalogy widget code
	$widget_code = sprintf( '
        <script data-cfasync=\'false\' type=\'text/javascript\'> /* generated by Ahalogy-WP wordpress plugin  [version %1$s] */
            (function(a,h,a_,l,o,g,y){
            window[a_]={c:o,b:g,u:l};var s=a.createElement(h);s.src=l,e=a.getElementsByTagName(h)[0];e.parentNode.insertBefore(s,e);
            })(document,\'script\',\'_ahalogy\',\'//w.ahalogy.com/\',{client:"%2$s"});
        </script>'
	,
		$this->plugin_version
	,
